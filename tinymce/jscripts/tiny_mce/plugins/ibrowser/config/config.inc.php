...
ob_start();
session_start( );
$memberfolder = $_SESSION['memberfolder'];
	// ================================================
...
//	);
	...
	$cfg['ilibs_dir'] 	   = array("$memberfolder");						   	// image library path with slashes; absolute to root directory - please make sure that the directories have write permissions
