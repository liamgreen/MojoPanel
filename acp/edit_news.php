...
</div></td><td><div align="center"><p class="subtitle"><?php echo $admin_titles09;?></p>
</div></td><td width="48">&nbsp;</td></tr></table><table width="95%" align="center"><tr><td class="general"> 
<?php $dir = $folder_path;
$filename = 'news.php';
...
<!-- /tinyMCE -->
<br><input type="hidden" name="filename" value="<?php echo($filename); ?>">
