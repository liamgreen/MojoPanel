...
if(!$_POST['rename_to']) {
die("<div class=\"general_center\"><font color=\"#FF0000\">What do you want to rename the file to?</font></div>");}
$new = strtolower($_POST['rename_to']);
$new = $new.'.'.$extn;
if(file_exists($new)){
die ("<div class=\"general_center\"><font color=\"#FF0000\">Unable to rename, the filename already exists!</font></div>");
}else{
if(strstr($new, '..')){
