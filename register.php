...
<tr> 
<td><br>
      <?php echo "$lang_register04";?>&nbsp;<?php echo "$lang_titles01";?>, <?php echo "$lang_register32";?> 
      <a href="terms.php"><?php echo "$lang_titles25";?></a>. <?php echo "$lang_register15";?><br>
      <br>
      <?php echo "$lang_register16";?> <?php echo "$lang_register23";?><br>
      <br>
      <?php echo "$lang_register02";?> </td>
</tr>
<tr> 
